...
export const dataTableConfig = {
  ...
  dateOperators: [
    { label: "Is", value: "date-eq" as const },
    { label: "Is not", value: "date-ne" as const },
    { label: "Is before", value: "date-lt" as const },
    { label: "Is after", value: "date-gt" as const },
    { label: "Is on or before", value: "date-lte" as const },
    { label: "Is on or after", value: "date-gte" as const },
  ...
  multiselectOperators: [
    { label: "Contains", value: "has" as const }, //has items in array
    { label: "Does not contain", value: "hasNot" as const }, //does not have items in array
    { label: "Is empty", value: "isEmpty" as const },
    { label: "Is not empty", value: "isNotEmpty" as const },
  ],
  booleanOperators: [
